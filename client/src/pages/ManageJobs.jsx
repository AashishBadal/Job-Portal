  ...
  return (
    <div className="container p-4 max-w-5xl">
          ...
          <tbody>
            {manageJobsData.map((job,index)=>(
              <tr key={index} className="text-gray-700">
                ...
                <td className="py-2 px-4 border-b border-gray-200"><input className="scale-125 ml-4" type="checkbox" /></td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div className="mt-4 flex justify-end">
        <button onClick={()=>navigate('/dashboard/add-job')} className="bg-black text-white p-2 px-4 rounded">
          Add new job
        </button>
      </div>
    </div>
